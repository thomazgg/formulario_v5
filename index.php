<?php
	...
	if (isset($_POST["botao"])) {
        ...
        // Sanitizações
        $_SESSION["nome"]   = filter_var($_SESSION["nome"] , FILTER_SANITIZE_SPECIAL_CHARS);
		$_SESSION["email"]  = filter_var($_SESSION["email"] , FILTER_SANITIZE_EMAIL);
        $_SESSION["senha"]  = filter_var($_SESSION["senha"] , FILTER_SANITIZE_SPECIAL_CHARS);
        $_SESSION["cpf"]    = filter_var($_SESSION["cpf"]   , FILTER_SANITIZE_NUMBER_INT);
...
?>
    ...
    <main class="container">
        ...
        <form method="POST" action="index.php">
            ...
            <div class="input-field">
                <input type="text"      name="cel"  maxlength="17"
                    value="<?php 
